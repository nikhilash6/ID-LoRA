...
def load_image_conditioning(
    ...
    Args:
        crf: Constant Rate Factor for H.264 encoding compression simulation.
             Higher values = more compression artifacts. Default is 33.
             Set to 0 to disable compression simulation.
    """
